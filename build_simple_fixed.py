#!/usr/bin/env python3
"""
Simple build script for Image Converter GUI - Fixed version
Creates a standalone executable using PyInstaller without version info issues
"""
...
def main():
    """Main build process"""
    print("🚀 Image Converter GUI - Simple Build (Fixed)")
    print("=" * 50)
